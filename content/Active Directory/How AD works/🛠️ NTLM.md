...
- NTLM is not tied to a specific transport protocol. Instead, it acts as a *negotiated authentication mechanism* embedded within various application protocols, including:
	...
	- **MSSQL** — database authentication over named pipes/TCP.
...
> - If you know the hash, you can authenticate as the user without knowing the plaintext password — this is the basis of **Pass-the-Hash attacks**.
