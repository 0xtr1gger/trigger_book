...
>[!note] See [[Windows privileges#`SeImpersonatePrivilege` and `SeAssignPrimaryTokenPrivilege`]] for more on these privileges and which accounts hold them by default.
