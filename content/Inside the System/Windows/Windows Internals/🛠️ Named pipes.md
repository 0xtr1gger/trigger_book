...
> [!note] See [[🛠️ Access tokens and impersonation]] for impersonation mechanics and token duplication. See [[🛠️ Windows privileges#`SeImpersonatePrivilege` and `SeAssignPrimaryTokenPrivilege`]] for which accounts hold the required privileges.
