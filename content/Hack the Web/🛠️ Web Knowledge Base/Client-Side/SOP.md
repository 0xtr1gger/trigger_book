...
>[!note] See [[CSRF#SameSite cookie attribute]].
## SOP restrictions 
...
- This prevents impact of certain client-side attacks.
	- For example, if an attacker injects JavaScript into a vulnerable application ([[XSS]]), the SOP prevents that script from directly reading data from unrelated origins.
