...
- CSP is primarily used to mitigate attacks such as [[XSS|Cross-Site Scripting (XSS)]]. It instructs the browser which sources are trusted for different resource types.
